...
The first deterministic TWAP demo from the current verification run used execution \code{exec\_8b651760392a48bb}. At 10 seconds into a 100 second target, it submitted one \(0.001\) BTC child against a \(0.010\) BTC target, matching the absolute schedule while reserving the open child quantity.
